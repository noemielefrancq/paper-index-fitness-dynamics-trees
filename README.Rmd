...
3. In ```3_Analysis_per_pathogen```, the analysis for each pathogen (will be updated soon)
...
Packages:
ape v5.7-1, phytools v1.9-16, stringr v1.5.0, MetBrewer v0.2.0, parallel v4.1.2, mgcv v1.8-42, cowplot v1.1.1, ggplot2 v3.4.3, ggtree v3.2.1.
